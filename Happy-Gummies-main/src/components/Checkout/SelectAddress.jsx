...
// function SelectAddress({ onSelect }) {
...
//     // Dummy data – Replace this with real address data from DB or state
...
//             shipping: {
//               house: "14",
//               addressLine: "Wall Street",
//               city: "New York",
//               state: "NY",
//               postalCode: "10005",
//               landmark: "Opposite Stock Exchange",
//             },
//             billing: {
//               house: "14",
//               addressLine: "Wall Street",
...
//     } else {
//       navigate("/checkout2", { state: { selectedAddress } });
//     }
//   };
...
//         <div className="add-new-address">
//           <img src={AddNewAddress} alt="Add new" />
//           <p>Add New Address</p>
//         </div>
//       </div>
...
function SelectAddress({ cartItems, total }) {
  const navigate = useNavigate();
  const [selected, setSelected] = useState(null);
  ...
  const handleChange = (e) => {
    ...
    // Prepare dummy address data (replace with real data if needed)
    const address =
      value === "home"
        ? {
            type: "Home",
    ...
    // Navigate directly to Checkout3 with address
    // navigate("/checkout3", { state: { selectedAddress: address } });
    navigate("/checkout3", {
      state: {
        cartItems,
        total,
        address, // not selectedAddress
      },
    });
  };
    ...
    <div className="select-address">
      ...
      <div className="select-address-options">
        ...
        <div className="add-new-address" onClick={handleAddNewAddress}>
          <img src={AddNewAddress} alt="Add New Address" />
          <p>Add New Address</p>
        </div>
      </div>
    </div>
